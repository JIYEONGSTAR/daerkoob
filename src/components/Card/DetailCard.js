...
const DetailCard = ({ currentBook }) => {
  function convertStringToDate(dateString){
    if(!dateString){
      ...
      return dateString.replace(/^(\d{4})(\d{2})(\d{2})/g, function(fullString, year, month, day){
    ...
    <div className="detailCard">
      ...
      <div className="detailCard__text">
        <div className="detailCard__text__info">
          ...
          <div className="detailCard__text__info__pubdate">{convertStringToDate(currentBook.pubdate)}</div>
        </div>
